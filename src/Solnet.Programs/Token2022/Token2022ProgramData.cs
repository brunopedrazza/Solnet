...
namespace Solnet.Programs.Token2022
{
    ...
    /// </summary>
    internal static class Token2022ProgramData
    {
        /// <summary>
        ...
        internal static byte[] EncodeRevokeData() => new[] { (byte)Token2022ProgramInstructions.Values.Revoke };
        ...
        internal static byte[] EncodeApproveData(ulong amount)
            => EncodeAmountLayout((byte)Token2022ProgramInstructions.Values.Approve, amount);
        ...
        internal static byte[] EncodeInitializeAccountData() =>
            new[] { (byte)Token2022ProgramInstructions.Values.InitializeAccount };
            ...
            PublicKey mintAuthority, PublicKey freezeAuthority, int decimals, int freezeAuthorityOption)
        {
            ...
            methodBuffer.WriteU8((byte)Token2022ProgramInstructions.Values.InitializeMint, MethodOffset);
        ...
        internal static byte[] EncodeTransferData(ulong amount)
            => EncodeAmountLayout((byte)Token2022ProgramInstructions.Values.Transfer, amount);
        ...
        internal static byte[] EncodeTransferCheckedData(ulong amount, int decimals)
            => EncodeAmountCheckedLayout((byte)Token2022ProgramInstructions.Values.TransferChecked, amount, (byte)decimals);
        ...
        internal static byte[] EncodeMintToData(ulong amount)
            => EncodeAmountLayout((byte)Token2022ProgramInstructions.Values.MintTo, amount);
        ...
        internal static byte[] EncodeInitializeMultiSignatureData(int m)
        {
            ...
            methodBuffer.WriteU8((byte)Token2022ProgramInstructions.Values.InitializeMultiSignature, MethodOffset);
        ...
        /// </summary>
        /// <returns>The byte array with the encoded data.</returns>
        internal static byte[] EncodeSetAuthorityData(Models.Token2022Program.AuthorityType authorityType, int newAuthorityOption,
            PublicKey newAuthority)
        {
            byte[] methodBuffer = new byte[35];

            methodBuffer.WriteU8((byte)Token2022ProgramInstructions.Values.SetAuthority, MethodOffset);
        ...
        internal static byte[] EncodeBurnData(ulong amount)
            => EncodeAmountLayout((byte)Token2022ProgramInstructions.Values.Burn, amount);

        /// <summary>
        /// Encode the transaction instruction data for the <see cref="Token2022ProgramInstructions.Values.CloseAccount"/> method.
        /// </summary>
        /// <returns>The byte array with the encoded data.</returns>
        internal static byte[] EncodeCloseAccountData() => new[] { (byte)Token2022ProgramInstructions.Values.CloseAccount };
        ...
        internal static byte[] EncodeFreezeAccountData() =>
            new[] { (byte)Token2022ProgramInstructions.Values.FreezeAccount };

        /// <summary>
        /// Encode the transaction instruction data for the <see cref="Token2022ProgramInstructions.Values.ThawAccount"/> method.
        /// </summary>
        /// <returns>The byte array with the encoded data.</returns>
        internal static byte[] EncodeThawAccountData() => new[] { (byte)Token2022ProgramInstructions.Values.ThawAccount };
        ...
        internal static byte[] EncodeApproveCheckedData(ulong amount, int decimals)
            => EncodeAmountCheckedLayout((byte)Token2022ProgramInstructions.Values.ApproveChecked, amount, (byte)decimals);
        ...
        internal static byte[] EncodeMintToCheckedData(ulong amount, int decimals)
            => EncodeAmountCheckedLayout((byte)Token2022ProgramInstructions.Values.MintToChecked, amount, (byte)decimals);
        ...
        internal static byte[] EncodeBurnCheckedData(ulong amount, int decimals)
            => EncodeAmountCheckedLayout((byte)Token2022ProgramInstructions.Values.BurnChecked, amount, (byte)decimals);
        ...
        internal static byte[] EncodeSyncNativeData() =>
            new[] { (byte) Token2022ProgramInstructions.Values.SyncNative };
